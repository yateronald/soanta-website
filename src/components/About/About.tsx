        ...
        <div className={`about__content ${isVisible ? 'about__content--visible' : ''}`}>
          ...
          <div className="about__stats">
            <div className="about__stat">
              <span className="about__stat-number">2022</span>
              <span className="about__stat-label">Année de création</span>
            </div>
            <div className="about__stat">
              <span className="about__stat-number">San Pedro</span>
              <span className="about__stat-label">Hub portuaire</span>
            </div>
            <div className="about__stat">
              <span className="about__stat-number">3</span>
              <span className="about__stat-label">Produits phares</span>
            </div>
            <div className="about__stat">
              <span className="about__stat-number">100%</span>
              <span className="about__stat-label">Traçabilité</span>
            </div>
          </div>
        </div>
      </div>
